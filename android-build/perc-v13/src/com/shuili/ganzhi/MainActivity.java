        ...
        wv.setDownloadListener(new DownloadListener() {
            ...
            public void onDownloadStart(String url, String userAgent, String contentDisposition, String mimetype, long contentLength) {
                try {
                    ...
                    // 保存到公共 Download 目录
                    File dir = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "水利感知项目一张图");
            ...
            public void run() {
                try {
                    ...
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(MainActivity.this, "已保存到: Download/水利感知项目一张图/" + file.getName(), Toast.LENGTH_LONG).show();
                        }
                    });
    ...
    private class JSBridge {
        ...
        public void saveBlob(String dataUrl, String fileName) {
            try {
                ...
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(MainActivity.this, "已保存到: Download/水利感知项目一张图/" + fileName, Toast.LENGTH_LONG).show();
                    }
                });
            } catch (final Exception e) {
                runOnUiThread(new Runnable() {
        ...
        public void saveBlobTo(String dataUrl, String folder, String fileName) {
            try {
                ...
                if (base64.contains(",")) base64 = base64.substring(base64.indexOf(",") + 1);
                byte[] bytes = android.util.Base64.decode(base64, android.util.Base64.DEFAULT);
                String f = (folder == null || folder.trim().isEmpty()) ? "水利感知项目一张图" : folder.trim().replaceAll("[/:*?\"<>|]", "_");
        ...
        public String exportPath(String name) {
            File f = new File(android.os.Environment.getExternalStoragePublicDirectory(
                android.os.Environment.DIRECTORY_DOWNLOADS), "水利感知项目一张图");
            f.mkdirs();
