...
BACKUP_DIR = os.path.join(ROOT, "backup_2026-08-30_before_v342")

PRODUCTS = {
    "shuili": dict(
        old_ver="3.41", new_ver="3.42", old_code=42, new_code=43,
        app_ver_has_v=True,
        ...
        deb_old="3.41.20260829", deb_new="3.42.20260830",
        msi_old="3.41.0", msi_new="3.42.0",
        ios_old="3.41_20260829", ios_new="3.42_20260830",
    ...
    "perc": dict(
        old_ver="1.17", new_ver="1.18", old_code=22, new_code=23,
        app_ver_has_v=True,
        ...
        deb_old="1.17.20260829", deb_new="1.18.20260830",
        msi_old="1.17.0", msi_new="1.18.0",
        ios_old="1.17_20260829", ios_new="1.18_20260830",
    ...
    "gujian": dict(
        old_ver="2.9", new_ver="3.0", old_code=22, new_code=23,
        app_ver_has_v=False,
        ...
        deb_old="2.9.20260829", deb_new="3.0.20260830",
        msi_old="2.9.0", msi_new="3.0.0",
        ios_old="2.9_20260829", ios_new="3.0_20260830",
