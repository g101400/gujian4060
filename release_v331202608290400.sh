...
ROOT="D:/Users/Claw"
DATE="20260827"
OUT_ROOT="${1:-$ROOT/APK归档/四端安装包_${DATE}_v333}"
UOS_ARCH="${2:-mips64el}"
...
PRODUCTS=(
"shuili|水利工程一张图|3.33|$ROOT/android-build/shuili-v329|$ROOT/native-shell/win-water-webview2|{A1B2C3D4-0001-4000-8000-000000000001}|水利工程基础信息一张图.exe"
"perc|水利感知项目一张图|1.9|$ROOT/android-build/perc-v13|$ROOT/native-shell/win-webview2|{B2C3D4E5-0002-4000-8000-000000000002}|水利感知项目一张图.exe"
"gujian|古建景点打卡|2.1|$ROOT/travel/android|$ROOT/native-shell/win-gujian-webview2|{C3D4E5F6-0003-4000-8000-000000000003}|古建景点打卡.exe"
)
