...
# 2026-09-08 夜班自省更新：对齐 2026-09-07 白天发版（公开 3.59/1.35/3.7.5 + 内部 3.60/1.36/3.7.5）
EXPECT = {"pub": {"shuili": ("3.59", "v3.59"), "perc": ("1.35", "v1.35"), "gujian": ("3.7.5", "3.7.5")},
          "int": {"shuili": ("3.60", "v3.60"), "perc": ("1.36", "v1.36"), "gujian": ("3.7.5", "3.7.5")}}
