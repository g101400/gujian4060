...
BACKUP_DIR = os.path.join(ROOT, "backup_2026-08-30_before_v343")

PRODUCTS = {
    "shuili": dict(
        old_ver="3.42", new_ver="3.43", old_code=43, new_code=44,
        app_ver_has_v=True,
        ...
        deb_old="3.42.20260830", deb_new="3.43.20260830",
        msi_old="3.42.0", msi_new="3.43.0",
        ios_old="3.42_20260830", ios_new="3.43_20260830",
    ...
    "perc": dict(
        old_ver="1.18", new_ver="1.19", old_code=23, new_code=24,
        app_ver_has_v=True,
        ...
        deb_old="1.18.20260830", deb_new="1.19.20260830",
        msi_old="1.18.0", msi_new="1.19.0",
        ios_old="1.18_20260830", ios_new="1.19_20260830",
    ...
    "gujian": dict(
        old_ver="3.0", new_ver="3.1", old_code=23, new_code=24,
        app_ver_has_v=False,
        ...
        deb_old="3.0.20260830", deb_new="3.1.20260830",
        msi_old="3.0.0", msi_new="3.1.0",
        ios_old="3.0_20260830", ios_new="3.1_20260830",
