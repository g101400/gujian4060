  ...
  function buildOvobj(list) {
    ...
    // 头部布局（对齐真实 .ovobj）：OviO(4) + 保留(8, 0x04-0x0B) + 对象数 int32(0x0C)
    //   + 保留(4, 0x10) + 总大小 int32(0x14) + 保留(4, 0x18) = 28 字节(0x1C)
    var head = new Uint8Array(0x1c);
  ...
  function exportOvobj() {
    ...
    __S().pickExportScope("ovobj", function (list) {
      if (!__OVOBJ_TEMPLATE) {
