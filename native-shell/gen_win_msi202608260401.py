...
PROJS = [
    {"key":"shuili","dir":"win-水利-水利工程一张图","name":"水利工程基础信息一张图","ver":"3.30.1","upg":"{A1B2C3D4-0001-4000-8000-000000000001}","exe":"水利工程基础信息一张图.exe"},
    {"key":"perc",  "dir":"win-感知-水利感知项目一张图","name":"水利感知项目一张图","ver":"1.6.1","upg":"{B2C3D4E5-0002-4000-8000-000000000002}","exe":"水利感知项目一张图.exe"},
    {"key":"gujian","dir":"win-古建-古建景点打卡","name":"古建景点打卡","ver":"1.8.1","upg":"{C3D4E5F6-0003-4000-8000-000000000003}","exe":"古建景点打卡.exe"},
]
