...
echo [3/3] 链接(light)...
"%WIX%bin\light.exe" -ext WixUIExtension -out "水利感知项目一张图_Setup.msi" build_msi.wixobj files.wixobj
if exist "水利感知项目一张图_Setup.msi" ( echo ✅ 产出：水利感知项目一张图_Setup.msi ) else ( echo ❌ 生成失败 )
endlocal
pause
