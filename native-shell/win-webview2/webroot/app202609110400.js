...
//   返回最强层级 + 命中值 + parentLevel（命中层级下一级，供 folder 子匹配用）
  ...
  var PLATFORM_COMPARE = [
    ...
    { v: "v1.42", d: "2026-09-09", note: "本版（内部版）：水利/感知 内部版新增访问口令保护（默认口令=开发者分机号 3305；记住口令 / 修改口令 / 忘记口令），公开版免密；版本与四平台同步。", rows: [
      { f: "内部版访问口令保护（默认口令=开发者分机号 3305）", a: "✅", i: "✅", w: "✅", u: "✅", n: "首启弹口令门+记住口令选项；设置-修改口令/忘记口令；公开版免密" }
    ],
    },

    { v: "v1.40", d: "2026-09-08", note: "本版（内部版，与水利 v3.64 / 古建 v3.7.7 同步）：①新增「智能化内核」菜单组（智能模糊检索 / 提示词生成器 / AI 记忆·Hermes / 存疑反向查询 / 强制联网）；②内部版加启动口令（3305）并把内部 PWA 数据整体加密后部署到公开仓库，解决私有仓库 Pages 不可用的同时防泄密；③GitHub 升级内部渠道免登录；④安卓 ovkmz 导入自动定位修复；⑤菜单 script error 根治。", rows: [
