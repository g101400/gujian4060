...
ARCHIVE = os.environ.get("WB_ARCHIVE") or os.path.join(ROOT, "APK归档", "测试包_20260909_v5_int", "win")
...
PROJS = [
    {"key":"shuili","proj":"win-water-webview2","pub":"publish_win_water",
     "name":"水利工程基础信息一张图","exe":"水利工程基础信息一张图.exe","exe_ascii":"ShuiliMap.exe","ver":"3.66.0",
     "appver":"3.64",
     "upg":"{A1B2C3D4-0001-4000-8000-000000000001}"},
    {"key":"perc","proj":"win-webview2","pub":"publish_win_perc",
     "name":"水利感知项目一张图","exe":"水利感知项目一张图.exe","exe_ascii":"ShuiliPerc.exe","ver":"1.42.0",
     "appver":"1.40",
     "upg":"{B2C3D4E5-0002-4000-8000-000000000002}"},
    {"key":"gujian","proj":"win-gujian-webview2","pub":"publish_win_gujian",
     "name":"古建景点打卡","exe":"古建景点打卡.exe","exe_ascii":"GujianMap.exe","ver":"3.7.8.0",
     "appver":"3.7.7",
