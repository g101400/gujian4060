...
def main():
    ...
    out_dir = os.environ.get("DEB_OUT_DIR") or os.path.join(
        ROOT, "APK归档", "测试包_20260913_v10_int", "uos-" + key)
    ...
    out = os.path.join(out_dir, "%s_%s_%s_new4060.deb" % (c["pkg"], c["ver"], arch))
